...
class $AssetsIllustrationsGen {
  ...
  /// File path: assets/illustrations/ethereum-eth-logo.svg
  SvgGenImage get ethereumEthLogo =>
      const SvgGenImage('assets/illustrations/ethereum-eth-logo.svg');

  /// List of all assets
  List<SvgGenImage> get values => [ethereumEthLogo];
}
